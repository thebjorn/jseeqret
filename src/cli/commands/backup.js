 ...
 * HTML file. The vault is encrypted with AES-256-GCM under a PBKDF2-derived
 * key and embedded in an HTML page that decrypts locally in any browser.
 * Restore by unlocking it, downloading the JSON, and importing that file.
 *
 * @example
 * jseeqret backup --out vault.html
 */
